...
Если один VL53L8CX не обнаруживается, сначала проверьте питание, LPn,
SPI_I2C_N и NCS. В SPI датчики различаются отдельными линиями NCS, а не I2C
адресом. Если LPn аппаратно удерживается в HIGH, укажите `-1` в поле LPn
строки `l8cx_spi`, чтобы демон не изменял GPIO, назначенный NCS.
