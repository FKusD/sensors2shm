...
#define VL53L8CX_API_REVISION			"VL53L8CX_2.1.0"
...
/**
 * @brief By default the CRC checksum is not calculated on the results packet. It can be activated using
 * VL53L8CX_CRC_RESULTS_PKT_ON and turned off again using VL53L8CX_CRC_RESULTS_PKT_OFF. This is done using the
 * function vl53l8cx_set_results_crc() which is included in the API.
 */
#define VL53L8CX_CRC_RESULTS_PKT_OFF	((uint8_t) 0U)
#define VL53L8CX_CRC_RESULTS_PKT_ON		((uint8_t) 1U)
...
#define VL53L8CX_DCI_CRC_RESULTS_PKT     ((uint16_t)0xE0C4U)
...
#define L8CX_AMB_SIZE	260U
#else
#define L8CX_AMB_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_NB_SPADS_ENABLED
#define L8CX_SPAD_SIZE	260U
#else
#define L8CX_SPAD_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_NB_TARGET_DETECTED
#define L8CX_NTAR_SIZE	68U
#else
#define L8CX_NTAR_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_SIGNAL_PER_SPAD
#define L8CX_SPS_SIZE ((256U * VL53L8CX_NB_TARGET_PER_ZONE) + 4U)
#else
#define L8CX_SPS_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_RANGE_SIGMA_MM
#define L8CX_SIGR_SIZE ((128U * VL53L8CX_NB_TARGET_PER_ZONE) + 4U)
#else
#define L8CX_SIGR_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_DISTANCE_MM
#define L8CX_DIST_SIZE ((128U * VL53L8CX_NB_TARGET_PER_ZONE) + 4U)
#else
#define L8CX_DIST_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_REFLECTANCE_PERCENT
#define L8CX_RFLEST_SIZE ((64U *VL53L8CX_NB_TARGET_PER_ZONE) + 4U)
#else
#define L8CX_RFLEST_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_TARGET_STATUS
#define L8CX_STA_SIZE ((64U  *VL53L8CX_NB_TARGET_PER_ZONE) + 4U)
#else
#define L8CX_STA_SIZE	0U
#endif

#ifndef VL53L8CX_DISABLE_MOTION_INDICATOR
#define L8CX_MOT_SIZE	144U
#else
#define L8CX_MOT_SIZE	0U
#endif
...
#define VL53L8CX_MAX_RESULTS_SIZE ( 40U \
	+ L8CX_AMB_SIZE + L8CX_SPAD_SIZE + L8CX_NTAR_SIZE + L8CX_SPS_SIZE \
	+ L8CX_SIGR_SIZE + L8CX_DIST_SIZE + L8CX_RFLEST_SIZE + L8CX_STA_SIZE \
	+ L8CX_MOT_SIZE + 20U)
...
typedef struct
{
    ...
    /* CRC for results packet */
    uint8_t             crc_checksum_for_results_pkt;
...
/**
 * @brief This function is used to enable or disable the results packet checksum.
 * When active the checksum will be calculated by the Vl53l8 and again on the host
 * to determine the integrity of the packet when received by the host.
 * @param (VL53L8CX_Configuration) *p_dev : VL53L8CX configuration structure.
 * @param (uint8_t) *checksum_setting :  Use macro VL53L8CX_CRC_RESULTS_PKT_OFF or VL53L8CX_CRC_RESULTS_PKT_ON
 * depending on the setting that is desired.
 * @return (uint8_t) status : 0 if OK
 */

uint8_t vl53l8cx_set_results_crc(
		VL53L8CX_Configuration		*p_dev,
		uint8_t		checksum_setting);
...
uint32_t vl53l8cx_generate_crc_checksum(uint32_t *memory_address,
